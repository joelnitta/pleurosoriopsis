...
```{r fig-6, fig.width=7, fig.height=8, fig.cap="Fig. 6. Relationships between growth of Pleurosoriopsis makinoi gametophytes (total cover, mean gemma number, and mean gemma length) and microclimate at the Okutama site. Microclimatic variables are monthly means of daily minimum relative humidity (%), daily mean temperature (°C), and daily light integral (DLI) (mol m-2 day-1). Grey bars show SD (except for total cover, which is a sum, not a mean). Significant relationships (linear model) shown with a line."}
